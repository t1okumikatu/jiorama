...
//列車衝突防止//2-24_17:19
<<<<<<< HEAD:2_15_Pinsyusei_jiorama_MEGA/2_15_Pinsyusei_jiorama_MEGA.ino
...
=======
//collision();
>>>>>>> parent of 6b82d65 (collision _test_3-2-20_ino):2_15_Pinsyusei_jiorama_MEGA.ino
  ...
  //[22]-------------------------------------------------
   ...
   if(TrainOutFlag2S==1 && digitalRead(digitalSubPin[Train[2]])==1){
    ...
    if(TrainOutFlag2S ==0  && digitalRead(digitalSubPin[Train[2]])==1){
      TrainOutFlag2S = 0;
      if(TrainOutFlag2S ==0 && digitalRead(digitalSubPin[Train[2]+1])==0){
       TrainOutFlag2S =1; 
       Train[2] = Train[2] + 1;
      }
    } 
